...
import { Post, PostItemID } from "../../Types/Types";
...
export const PostFooter:FC<postProps> = ({post}) => {
    ...
    return (
        <>
            <div className="row align-items-center">
                ...
                <PostDeleteButton post_id={post.article_id} />
                <PostEditButton post_id={post.article_id} />
